...
// let arrFind = arr.find((item) => item.id == 11075);
// console.log(arrFind);
...
// //2) İstifadəçi bir ədəd (A) daxil edir. 1-dən 1000-ə qədər A-ya bölünən bütün ədədləri çap edin.
// // let a = 5;
// // let newArr = [];
...
// // }
// let a=5
// let dvide=Array.filter(num=>num%a==0)

// 1)Date obyektindən istifadə etməklə elə bir funksiya yazın ki, istifadəçi sayta daxil olanda daxil olduğuvaxta əsasən alert mesajı çıxartsın və body backgroundu dəyişsin. (Məsələn, günorta saatlarıdırsa, GÜNORTANIZ XEYİR mesajlı alert və body-in rənginin narıncı olması və s.)

let tarix = new Date();
let time = tarix.getHours();

function dateMessage() {
  if (12 < time < 18) {
    alert(`gunortaniz xeyir, saat ${tarix.toLocaleTimeString()}-dir,`);
    let body = document.querySelector("body");
    body.style.backgroundColor = "orange";
  } else {
    alert(`her vaxtiniz xeyir, saat ${tarix.toLocaleTimeString()}-dir,`);
    let body = document.querySelector("body");
